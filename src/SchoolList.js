              ...
              <li key={school.id} className="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 m-4 text-center">
                {
                  <div>
                    ...
                    <div>
                      <select className="block appearance-none w-full bg-gray-100 border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 m-4 rounded shadow leading-tight focus:outline-none focus:shadow-outline" value={studentId} onChange={ev => setStudentId(ev.target.value)}>
